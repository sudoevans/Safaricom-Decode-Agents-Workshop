...
Just run it, then configure your Foundry Toolkit agent to use it.

Supports two transport modes:
  stdio: python mcp-server/server.py --stdio   (used by Foundry Toolkit Agent Builder)
...
def main() -> None:
    ...
    parser.add_argument(
        "--stdio",
        action="store_true",
        help="Run server in stdio mode (used by Foundry Toolkit Agent Builder)",
    )
