...
Everything you built today in Foundry Toolkit has a production-grade equivalent in Microsoft Foundry:

| What we did in Foundry Toolkit | What you can do in Microsoft Foundry |
|---------------------------|--------------------------------------|
