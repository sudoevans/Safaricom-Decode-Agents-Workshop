...
Build **Biashara Agent**, a bilingual customer assistant for Savanna Bites restaurant (Nairobi) using **Microsoft Foundry** and the **Foundry Toolkit** in VS Code.
...
- Explore and compare models with the Foundry Toolkit Playground
...
- VS Code with the [Foundry Toolkit](https://aka.ms/AIToolkit) extension (version 0.32.1 or later)
