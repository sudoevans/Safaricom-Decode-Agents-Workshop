...
>
> Based on [BRK441: Build and launch AI agents fast with Microsoft Foundry and the Foundry Toolkit](https://github.com/microsoft/aitour26-BRK441-Build-and-launch-AI-agents-fast-with-Microsoft-Foundry-and-the-AI-Toolkit)
...
| **Target outcome** | Every participant has a working, bilingual, MCP-connected agent running in Foundry Toolkit with evaluations |
...
**What to say:**
> "Today you're going to build a real AI agent — not a chatbot that just regurgitates answers, but one that reasons, fetches data, and follows rules. The scenario: Savanna Bites Restaurant in Nairobi CBD needs a 24/7 bilingual assistant. You'll build it using Microsoft Foundry and the Foundry Toolkit."
...
**What to say:**
> "In a real project, you don't ship an agent by 'it seems to work'. You write test cases and run them. The Foundry Toolkit lets you do manual evaluation AND AI-assisted evaluation right inside the Agent Builder."
...
- Point them to the **Foundry Toolkit documentation** and **Microsoft Foundry** for next steps
